...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create author for pagination tests
        number_of_author = 13
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_books_books_in_list(self):
        login = self.client.login(username='testuser1', password='1X<ISRUkw+tuK')
        response = self.client.get(reverse('my-books'))
        ...
        # Check that now we have books books in the list
        response = self.client.get(reverse('my-books'))
        # Check our user is logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check that we got a response "success"
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_books_book(self):
    ...
    def test_logged_in_with_permission_another_users_books_book(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}))
    ...
    def test_redirects_to_all_books_book_list_on_success(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
